...
class EventGroupsControllerTest < ActionController::TestCase
  ...
  test "should create event_group" do
    assert_difference('EventGroup.count') do
      post :create, event_group: { description: @event_group.description, executed_count: @event_group.executed_count, executed_last: @event_group.executed_last, favorite: @event_group.favorite, name: @event_group.name, status: @event_group.status }
    end
  ...
  test "should update event_group" do
    patch :update, id: @event_group, event_group: { description: @event_group.description, executed_count: @event_group.executed_count, executed_last: @event_group.executed_last, favorite: @event_group.favorite, name: @event_group.name, status: @event_group.status }
    assert_redirected_to event_group_path(assigns(:event_group))
  end
